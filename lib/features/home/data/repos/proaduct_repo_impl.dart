...
import 'package:fruit_hup/features/home/data/models/proaduct_model.dart';
...
class ProaductRepoImpl extends ProaductRepo {
  ...
  @override
  Future<Either<Failure, List<ProaductEntity>>> getTheBestSellingProaducts(
    String path,
  ) async {
    try {
      var data =
          await firebaseFirestoreService.getData(
                path: path,
                filter: {
